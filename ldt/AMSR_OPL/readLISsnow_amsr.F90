...
! 
! !INTERFACE: 
subroutine readLIS_snow_amsr(n,yyyymmdd,hh,SnowDepth)
! !USES:
  use LDT_coreMod
  use LDT_logMod
  use LDT_amsr_oplMod
...
end subroutine readLIS_snow_amsr

!BOP
! 
! !ROUTINE: read_lisSnowD_data
! \label{read_lisSnowD_data}
!
! !INTERFACE:
subroutine read_lisSnowD_data(n,fname,SnowDepth)
! 
! !USES:
  use LDT_logMod
  use LDT_coreMod
...
end subroutine read_lisSnowD_data

!BOP
! !ROUTINE: create_lisSnowD_filename
! \label{create_lisSnowD_filename}
! 
! !INTERFACE:
subroutine create_lisSnowD_filename(LISdir,yyyymmdd,hh,filename)
! !USES:
...
end subroutine create_lisSnowD_filename
