...
|"`WSF soil moisture`" | Operational 10-km (ARFS grid) WSF soil moisture retrieval 
...
`WSF soil moisture data directory:` specifies the location of the data directory containing the WSF soil moisture data data.

.Example _ldt.config_ entry
....
WSF soil moisture data directory: ../wsf
....
